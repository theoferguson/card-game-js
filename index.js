...
function gameOver() {
    ...
    const gameOverMessage = `Game Over! Your score was <span class="badge">${score}</span>
...
function outputChoiceFeedback(hit) {
    if(hit) {
        ...
        updateStatusElement(currentGameStatusElem, "block", loseColor, ":(")
    }
}
...
function initializeNewRound() {
    ...
    updateStatusElement(currentGameStatusElem, "block", primaryColor, "Shuffling Cards...")
...
function shuffleCards() {
    ...
    function shuffle() {
        ...
        if (shuffleCount == 500) {
            ...
            shufflingInProgress = false
            dealCards()
            updateStatusElement(currentGameStatusElem, "block", primaryColor, "where is the Ace of Spades?")
        } else {
            shuffleCount++;
        }
    }
...
function createCard(cardItem) {
    ...
    attachClickEventListener(cardElem)
}
